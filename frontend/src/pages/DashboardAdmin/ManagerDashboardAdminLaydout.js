        ...
        <Drawer variant="permanent" open={open}>
          ...
          <List component="nav">
            <React.Fragment>
              ...
              <ListItemButton
                onClick={() => navigate("/admin/manage-return-requests")}
                selected={currentPath === "/admin/manage-return-requests"}
              >
                <ListItemIcon sx={{ color: "primary.contrastText" }}>
                  <AssignmentReturnIcon />{" "}
                  {/* bạn đã import sẵn icon này ở đầu file */}
                </ListItemIcon>
                <ListItemText
                  primary="Manage Return"
                  primaryTypographyProps={{
                    fontWeight:
                      currentPath === "/admin/manage-return-requests"
                        ? "bold"
                        : "normal",
                  }}
                />
